...
module.exports.run = async function ({ api, event, args }) {
 try {
  ...
  if (!prompt) {
   return api.sendMessage('salut je m'appelle auto-minato un auto-bot très rapide.Comment puis je vous aider aujourd'hui?⚡\n\n⚡Createur: Chris st☘️', event.threadID, messageID);
  }
